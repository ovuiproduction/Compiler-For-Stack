...
typedef enum { INT_TYPE, VOID_TYPE, CHAR_TYPE, STRING_TYPE,STACK_CHAR_TYPE, STACK_INT_TYPE,NONE_TYPE } VarType;
...
void stack_typemismatch1(const char* variable,const char* scope,const char* function){
...
stack_declaration:
    ...
    {
        add_symbol($5, STACK_CHAR_TYPE, current_function_name, false);
        symbol_table[symbol_count - 1].param_count = 1;
        symbol_table[symbol_count - 1].val_type = STATIC;
